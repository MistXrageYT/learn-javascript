//what it operators?
//answer: operators are symbols that perform a specific task.

//can we create an operator?
//answer: no, we can't

//what is the difference between operators and functions?
//answer: operators are symbols that perform a specific task. Functions are blocks of code that can be used to perform a specific task.
...
//answer: == is used to compare the value of two variables. === is used to compare the value and the type of two variables. 
